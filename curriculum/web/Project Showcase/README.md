...
+ 다시 프로젝트 전시 트링켓으로 돌아와서  `<h2>` 헤딩과 생일 축하 프로젝트의 링크를 더하세요.
...
완성한 프로젝트를 embed 해서 더 많이 전시해보세요. 웹페이지의 링크를 클릭해서 각 프로젝트의 트링켓 페이지를 쉽게 찾을 수 있다는 걸 잊지 마세요.
